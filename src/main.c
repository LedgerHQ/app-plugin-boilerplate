...
const uint8_t OETH_ADDRESS[ADDRESS_LENGTH] = {
    0x85, 0x6c, 0x4e, 0xfb, 0x76, 0xc1, 0xd1, 0xae, 0x02, 0xe2,
    0x0c, 0xeb, 0x03, 0xa2, 0xa6, 0xa0, 0x8b, 0x0b, 0x8d, 0xc3};

const uint8_t STETH_ADDRESS[ADDRESS_LENGTH] = {
    0xae, 0x7a, 0xb9, 0x65, 0x20, 0xde, 0x3a, 0x18, 0xe5, 0xe1,
    0x11, 0xb5, 0xea, 0xab, 0x09, 0x53, 0x12, 0xd7, 0xfe, 0x84};

const uint8_t OUSD_ADDRESS[ADDRESS_LENGTH] = {
    0x2a, 0x8e, 0x1e, 0x67, 0x6e, 0xc2, 0x38, 0xd8, 0xa9, 0x92,
    0x30, 0x7b, 0x49, 0x5b, 0x45, 0xb3, 0xfe, 0xaa, 0x5e, 0x86};

const uint8_t DAI_ADDRESS[ADDRESS_LENGTH] = {
    0x6b, 0x17, 0x54, 0x74, 0xe8, 0x90, 0x94, 0xc4, 0x4d, 0xa9,
    0x8b, 0x95, 0x4e, 0xed, 0xea, 0xc4, 0x95, 0x27, 0x1d, 0x0f};

const uint8_t USDC_ADDRESS[ADDRESS_LENGTH] = {
    0xa0, 0xb8, 0x69, 0x91, 0xc6, 0x21, 0x8b, 0x36, 0xc1, 0xd1,
    0x9d, 0x4a, 0x2e, 0x9e, 0xb0, 0xce, 0x36, 0x06, 0xeb, 0x48};

const uint8_t USDT_ADDRESS[ADDRESS_LENGTH] = {
    0xda, 0xc1, 0x7f, 0x95, 0x8d, 0x2e, 0xe5, 0x23, 0xa2, 0x20,
    0x62, 0x06, 0x99, 0x45, 0x97, 0xc1, 0x3d, 0x83, 0x1e, 0xc7};

const uint8_t OETH_VAULT_ADDRESS[ADDRESS_LENGTH] = {
    0x39, 0x25, 0x40, 0x33, 0x94, 0x5a, 0xa2, 0xe4, 0x80, 0x9c,
    0xc2, 0x97, 0x7e, 0x70, 0x87, 0xbe, 0xe4, 0x8b, 0xd7, 0xab};

const uint8_t WOETH_ADDRESS[ADDRESS_LENGTH] = {
    0xdc, 0xee, 0x70, 0x65, 0x42, 0x61, 0xaf, 0x21, 0xc4, 0x4c,
    0x09, 0x3c, 0x30, 0x0e, 0xd3, 0xbb, 0x97, 0xb7, 0x81, 0x92};

const uint8_t CURVE_OETH_POOL_ADDRESS[ADDRESS_LENGTH] = {
    0x94, 0xb1, 0x74, 0x76, 0xa9, 0x3b, 0x32, 0x62, 0xd8, 0x7b,
    0x9a, 0x32, 0x69, 0x65, 0xd1, 0xe9, 0x1f, 0x9c, 0x13, 0xe7};

const uint8_t CURVE_OUSD_POOL_ADDRESS[ADDRESS_LENGTH] = {
    0x87, 0x65, 0x0d, 0x7b, 0xbf, 0xc3, 0xa9, 0xf1, 0x05, 0x87,
...
const uint8_t NULL_ETH_ADDRESS[ADDRESS_LENGTH] = {
